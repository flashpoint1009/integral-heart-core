    ...
    Tables: {
      ...
      bonuses: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "bonuses_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      rep_check_ins: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rep_check_ins_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      rep_routes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rep_routes_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      rep_visits: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rep_visits_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
